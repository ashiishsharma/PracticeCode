 ...
 * larger one).
 * <p>You have the following constraints:
 * <p>(1) Only one disk can be moved at a time.
 * <p>(2) A disk is slid off the top of one tower onto the next rod.
 * <p>(3) A disk can only be placed on top of a larger disk.
 * Write a program to move the disks from the first tower to the last using Stacks.
 *
 * @author Ashish Sharma on 12-10-2016.
 */
